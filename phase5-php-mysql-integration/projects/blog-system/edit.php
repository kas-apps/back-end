...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!isset($_POST['csrf_token']) || !verifyCsrfToken($_POST['csrf_token'])) {
        ...
        if (empty($errors)) {
            ...
            if (updatePost($post_id, $update_data)) {
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .post-info { color: #666; font-size: 14px; margin-bottom: 30px; padding-bottom: 20px; border-bottom: 1px solid #eee; }
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-container">
            <h1>✏️ 記事を編集</h1>
            <div class="post-info">
                記事ID: <?php echo h($post['id']); ?> |
                作成: <?php echo date('Y年m月d日 H:i', strtotime($post['created_at'])); ?> |
                更新: <?php echo date('Y年m月d日 H:i', strtotime($post['updated_at'])); ?>
            </div>
